...
var arrayReplaceAll = function(srcArray,descArray){
 ...
 * @param {Object} map
 */
var mapToArray = function (map,key="key",value="value") {
	if(map){
		let array = [];
		for(let k in map){
			let item = {};
...
var arrayReplace =  function(srcarray,descarray) {
	if(srcarray){
...
var replaceAttr =  function(array,replaceatt,childrenkey) {
